    ...
    private int say(CommandContext<ServerCommandSource> context) {
        ...
        CompletableFuture.runAsync(() -> {
            try {
                if (finalPlayer != null) {
                    // 创建玩家信息
                    org.lby123165.easybot.bridge.model.PlayerInfo playerInfo = new org.lby123165.easybot.bridge.model.PlayerInfo(
                        finalPlayerName,
                    ...
                    org.lby123165.easybot.bridge.model.PlayerInfoWithRaw infoWithRaw = 
                        new org.lby123165.easybot.bridge.model.PlayerInfoWithRaw(playerInfo, finalPlayerName);
    ...
    private int crossServerSay(CommandContext<ServerCommandSource> context) {
        ...
        CompletableFuture.runAsync(() -> {
            try {
                ...
                org.lby123165.easybot.bridge.model.PlayerInfoWithRaw infoWithRaw = 
                    new org.lby123165.easybot.bridge.model.PlayerInfoWithRaw(playerInfo, playerName);
